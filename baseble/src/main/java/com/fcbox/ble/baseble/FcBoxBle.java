...
import com.fcbox.ble.baseble.callback.scan.ScanCallback;
...
import com.fcbox.ble.baseble.core.DeviceMirrorPool;
...
public class FcBoxBle {
    ...
    private static FcBoxBle instance;//入口操作管理
     ...
     */
    public static FcBoxBle getInstance() {
        if (instance == null) {
            synchronized (FcBoxBle.class) {
                if (instance == null) {
                    instance = new FcBoxBle();
                }
            }
        }
        return instance;
