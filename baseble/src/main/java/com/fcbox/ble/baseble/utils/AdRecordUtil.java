package com.fcbox.ble.baseble.utils;

import android.annotation.SuppressLint;
import android.util.SparseArray;


import com.fcbox.ble.baseble.model.adrecord.AdRecord;
...
public class AdRecordUtil {
    ...
    public static Map<Integer, AdRecord> parseScanRecordAsMap(final byte[] scanRecord) {
        @SuppressLint("UseSparseArrays") final Map<Integer, AdRecord> records = new HashMap<>();
